...
CWater::CWater(CWnd* pParent /*=NULL*/)
	: CDialog(CWater::IDD, pParent)
{
	//{{AFX_DATA_INIT(CWater)
	m_direc = 0;
	m_fig1 = 0;
	m_fig2 = 0;
	m_fig3 = 0;
...
void CWater::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CWater)
	DDX_Control(pDX, IDC_OK, m_idok);
...
BEGIN_MESSAGE_MAP(CWater, CDialog)
	//{{AFX_MSG_MAP(CWater)
