...
public:
	...
	int bot,top;
	int r1,l1,r2,l2,r3,l3,r4,l4,r5,l5,r6,l6,r7,l7,r8,l8;
...
protected:
	...
	afx_msg void OnzishiyingFa();
	afx_msg void Onhuiduchuli();
	afx_msg void Onbianyuantiqu();
	afx_msg void Onjiequ();
	afx_msg void Ontiquerzhihua();
	afx_msg void Onchepaifenge();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
